-- ============================================================
-- PROYECTO BD SAKILA - RESOLUCIÓN DE CONSULTAS SQL
-- ============================================================

-- 1. Crea el esquema de la BBDD: Presente en la pestaña public, Diagrama --
...
select r.rental_id, r.rental_date, p.amount as "coste"
from rental r 
join payment p on r.rental_id = r.rental_id 
...
select rating, AVG(f.length ) as "promedio_duracion"
from film f 
group by f.rating
...
select AVG(f.length) as promedio_duracion, c."name" as categoria 
from category c 
...
-- Contestación: No, no aporta valor porque esta consulta genera combinaciones ficticias que no existen realmente en la base de datos. Por ejemplo, asigna todas las categorias existentes a todas las peliculas. --
